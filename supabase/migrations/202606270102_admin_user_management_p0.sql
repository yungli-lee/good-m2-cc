...
alter type public.audit_action add value if not exists 'user_disabled';
alter type public.audit_action add value if not exists 'user_restored';
alter type public.audit_action add value if not exists 'display_name_updated';
alter type public.audit_action add value if not exists 'failed_permission_attempt';
